...
function(ci_make_app)
    ...
    if("${CMAKE_RUNTIME_OUTPUT_DIRECTORY}" STREQUAL "")
        if(DEFINED ENV{CLION_IDE})
            ...
            MESSAGE(STATUS "; <${PROJECT_NAME}> (DEBUG) CLion detected, \${CMAKE_RUNTIME_OUTPUT_DIRECTORY}\ will be set to: ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}")
            MESSAGE(STATUS "; <${PROJECT_NAME}> (DEBUG) \${CMAKE_RUNTIME_OUTPUT_DIRECTORY}\ returns: ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}")
        else()
